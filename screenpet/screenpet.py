...
def show_happy(event):
    if(20<= event.x and event.x <= 380) and (50<= event.y and event.y <= 350):
...
eye_right = c.create_oval(270,110,240,170,outline='black' , fill='white')
pupil_right = c.create_oval(260,145,250,155,outline='black' , fill='black')
...
cheek_left = c.create_oval(70,180,120,230,outline='pink' , fill='pink',state=NORMAL)
cheek_right = c.create_oval(330,180,280,230,outline='pink' , fill='pink',state=NORMAL)
